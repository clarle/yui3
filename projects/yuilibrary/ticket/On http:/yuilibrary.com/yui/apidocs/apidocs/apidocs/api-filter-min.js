...
<html>
    <head>
        <title>YUI Website - YUI Library</title>
<meta charset="utf-8">

<link rel="stylesheet" href="http://yui.yahooapis.com/combo?2.8.2/build/reset-fonts-grids/reset-fonts-grids.css">
<link rel="stylesheet" href="/assets/skin/yuilib-08.25.2011.css">

<!-- Fetching Partial from Node site: Thu, 04 Sep 2014 01:07:25 +0000 -->
<!-- http://yuilibrary.com/_partial/html-head -->
...
<!-- Finished fetching Partial: Thu, 04 Sep 2014 01:07:25 +0000 -->

<script src="http://yui.yahooapis.com/combo?2.8.2/build/yuiloader-dom-event/yuiloader-dom-event.js"></script>
<script>
var YUIConfig = {
    baseyui2: 'http://yui.yahooapis.com/2.8.2/build/',
    debug: false
};
</script>
    <script>
        YAHOO.namespace('tracker');
        YAHOO.tracker.baseURL = '/projects/yuilibrary/';
        YAHOO.tracker.projectName = 'yuilibrary';
        YAHOO.util.Dom.addClass(document.documentElement, 'js');
    </script>
  </head>
<body class="trac yui3-skin-sam">
<div id="wrap">
		<div id="doc3" class="yui-t7">
            ...
            <div class="yui3-u-1-4"><!-- Fetching Partial from Node site: Thu, 04 Sep 2014 01:07:25 +0000 -->
<!-- http://yuilibrary.com/_partial/searchbox -->
...
<!-- Fetching Partial from Node site: Thu, 04 Sep 2014 01:07:25 +0000 -->
<!-- http://yuilibrary.com/_partial/sitenav?tab=Other+Projects -->
...
<!-- Finished fetching Partial: Thu, 04 Sep 2014 01:07:25 +0000 -->
    	...
    	<div id="bd">
			...
			<div id="subnav">
                ...
                <nav>		        <ul class="subnav">                    <li class="first"><a href="/projects/yuilibrary/" title="Project Home">Project Home</a></li>
                    <li><a href="/projects/yuilibrary/wiki" title="Wiki">Wiki</a></li>                    <li><a href="/forum/viewforum.php?f=28" title="Forum">Forum</a></li>                    <li class="active"><a href="/projects/yuilibrary/report" title="View Tickets">View Tickets</a></li><li><a href="/projects/yuilibrary/newticket" title="New Ticket">New Ticket</a></li>                </ul>
                </nav>
			</div>
                </div>
            </div>
	        ...
	        <div id="yui-main">
	            ...
	            <div class="yui-b main">                    <div id="main">
                        <div id="ctxtnav">
    ...
    <p class="message">Ticket #On http:/yuilibrary.com/yui/apidocs/apidocs/apidocs/api-filter-min.js could not be found.</p>
</div>
                        </div>
                    </div>        </div>
    </div>
</div>
<div id="ft"><p class="copyright">
...
</div><!-- Fetching Partial from Node site: Thu, 04 Sep 2014 01:07:25 +0000 -->
<!-- http://yuilibrary.com/_partial/footer-js -->
...
<!-- Finished fetching Partial: Thu, 04 Sep 2014 01:07:25 +0000 -->
<script src="/assets/combo.php?phptrac/datatable-03.16.2011.js"></script>
